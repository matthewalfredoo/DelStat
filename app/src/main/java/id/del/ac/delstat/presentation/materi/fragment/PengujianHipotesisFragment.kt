...
import id.del.ac.delstat.databinding.FragmentPengujianHipotesisBinding
...
class PengujianHipotesisFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_9_PENGUJIAN_HIPOTESIS

    private lateinit var binding: FragmentPengujianHipotesisBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pengujian_hipotesis, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding = FragmentPengujianHipotesisBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_6))
        binding.imageView7.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_7))
        binding.imageView8.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_8))
        binding.imageView9.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_9))
        binding.imageView10.setImage(ImageSource.resource(R.drawable.materi_pengujian_hipotesis_10))
    }
