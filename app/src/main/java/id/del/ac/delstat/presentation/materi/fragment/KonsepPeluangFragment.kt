...
import id.del.ac.delstat.databinding.FragmentAnovaBinding
import id.del.ac.delstat.databinding.FragmentKonsepPeluangBinding
...
class KonsepPeluangFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_1_KONSEP_PELUANG

    private lateinit var binding: FragmentKonsepPeluangBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentKonsepPeluangBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_6))
        binding.imageView7.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_7))
        binding.imageView8.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_8))
        binding.imageView9.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_9))
        binding.imageView10.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_10))
        binding.imageView11.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_11))
        binding.imageView12.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_12))
        binding.imageView13.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_13))
        binding.imageView14.setImage(ImageSource.resource(R.drawable.materi_konsep_peluang_14))
    }
