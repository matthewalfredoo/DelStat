...
import id.del.ac.delstat.databinding.FragmentVariabelAcakBinding
...
class VariabelAcakFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_2_VARIABEL_ACAK

    private lateinit var binding: FragmentVariabelAcakBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_variabel_acak, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding = FragmentVariabelAcakBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_6))
        binding.imageView7.setImage(ImageSource.resource(R.drawable.materi_variabel_acak_7))
    }
