...
import id.del.ac.delstat.databinding.FragmentTeknikSamplingBinding
...
class TeknikSamplingFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_6_TEKNIK_SAMPLING

    private lateinit var binding: FragmentTeknikSamplingBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_teknik_sampling, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding = FragmentTeknikSamplingBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_teknik_sampling_6))
    }
