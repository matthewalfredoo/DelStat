...
import id.del.ac.delstat.databinding.FragmentPengantarStatistikAnalisisDataBinding
...
class PengantarStatistikAnalisisDataFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_5_PENGANTAR_STATISTIK_ANALISIS_DATA

    private lateinit var binding: FragmentPengantarStatistikAnalisisDataBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_pengantar_statistik_analisis_data,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentPengantarStatistikAnalisisDataBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_6))
        binding.imageView7.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_7))
        binding.imageView8.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_8))
        binding.imageView9.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_9))
        binding.imageView10.setImage(ImageSource.resource(R.drawable.materi_pengantar_statistik_10))
    }
