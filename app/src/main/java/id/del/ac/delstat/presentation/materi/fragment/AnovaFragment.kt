...
class AnovaFragment : Fragment() {
    private val IDMATERI = Materi.ID_MATERI_7_ANOVA

    private lateinit var binding: FragmentAnovaBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_anova, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding = FragmentAnovaBinding.bind(view)
    ...
    private fun renderImages() {
        binding.imageView1.setImage(ImageSource.resource(R.drawable.materi_anova_1))
        binding.imageView2.setImage(ImageSource.resource(R.drawable.materi_anova_2))
        binding.imageView3.setImage(ImageSource.resource(R.drawable.materi_anova_3))
        binding.imageView4.setImage(ImageSource.resource(R.drawable.materi_anova_4))
        binding.imageView5.setImage(ImageSource.resource(R.drawable.materi_anova_5))
        binding.imageView6.setImage(ImageSource.resource(R.drawable.materi_anova_6))
    }
